...
function renderListingCard(p) {
  ...
  return `<article class="profile-card horizontal-card listing-result-card">
    <div class="card-media listing-media">
      <button class="listing-card-avatar-button" type="button" data-open-listing="${escapeHTML(p.id)}" aria-label="View ${escapeHTML(title)} listing">
        <div class="avatar">${image}</div>
      </button>
    </div>
    <div class="card-main listing-card-main">
      ...
      <div class="listing-card-side">
        ...
        <div class="card-actions listing-card-actions">
